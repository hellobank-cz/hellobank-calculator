...
class CtlmCiselnik {
	...
	public function getInfo()
	{
		...
		$this->baremy = array();
		$data = file_get_contents(CTLM_URL_INFO, false, stream_context_create($arrContextOptions));
	...
	public function getPojisteniList() 
	{
		...
		$data = file_get_contents(CTLM_URL_POJISTENI, false, stream_context_create($arrContextOptions));
		$xml = simplexml_load_string($data);
